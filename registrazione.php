    ...
    <script>
        ...
        function controllo(){
            if(document.getElementById("footballer").checked){
              ...
              document.getElementById("city").placeholder="Località di residenza";
            }
            else{
              ...
              document.getElementById("city").placeholder="Località di sede";
            }
        }
    ...
    <div class="main-block">
        ...
        <form name="registrazione">
          ...
          <div style="text-align: center;">
            <span style="text-align: center; font-size:15px">Hai già un account? </span>
